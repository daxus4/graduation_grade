...
class Exam {
  ...
  int getMark() {
    if (!_isTaken) throw ExamNotTakenException();
    return _mark;
  }
  ...
  bool operator ==(o) {
    if (!o._isTaken)
      return o is Exam &&
          o._name == this._name &&
          o._cfu == this._cfu &&
          o._isTaken == this._isTaken;
    return o is Exam &&
        o._name == this._name &&
        o._cfu == this._cfu &&
        o._isTaken == this._isTaken &&
        o._mark == this._mark &&
        o._cumLaude == this._cumLaude;
  }

  @override
  int get hashCode => this._isTaken
      ? hashValues(_name, _cfu, _isTaken, _mark, _cumLaude)
